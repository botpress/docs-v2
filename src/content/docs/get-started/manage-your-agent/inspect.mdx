...
<Frame>
  <img alt="Logs" class="block dark:hidden" src="./assets/logs.png" />
  <img alt="Logs" class="hidden dark:block" src="./assets/logs-dark.png" />
</Frame>
...
<Frame>
  <img alt="Events" class="block dark:hidden" src="./assets/events.png" />
  <img alt="Events" class="hidden dark:block" src="./assets/events-dark.png" />
</Frame>
...
<Frame>
  <img alt="Event JSON data" class="block dark:hidden" src="./assets/event-json-data.png" />
  <img alt="Event JSON data" class="hidden dark:block" src="./assets/event-json-data-dark.png" />
</Frame>
...
<Frame>
  <img alt="File JSON data" class="block dark:hidden" src="./assets/file-json-data.png" />
  <img alt="File JSON data" class="hidden dark:block" src="./assets/file-json-data-dark.png" />
</Frame>
...
<Frame>
  <img alt="Issues" class="block dark:hidden" src="./assets/issues.png" />
  <img alt="Issues" class="hidden dark:block" src="./assets/issues-dark.png" />
</Frame>
...
<Frame>
  <img alt="Issue events" class="block dark:hidden" src="./assets/issue-events.png" />
  <img alt="Issue events" class="hidden dark:block" src="./assets/issue-events-dark.png" />
</Frame>
