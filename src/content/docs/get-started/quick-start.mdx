...
import { Tip, Note, Check } from '@/components/callouts'
...
<Tip>Visual learner? Check out our [platform walkthrough on YouTube](https://www.youtube.com/watch?v=41U-ofr7MxE).</Tip>
...
<Steps>
  ...
  <Step>
    Follow the on-screen instructions to configure your first bot. We'll take care of everything for you, and your AI
    agent will be ready to test and deploy within minutes.
  </Step>
</Steps>
...
<CardGroup>
  <Card title="Add to your website" icon="MessageSquare" href="/webchat/get-started/introduction">
...
<Check>You just built and deployed your first bot with Botpress!</Check>
