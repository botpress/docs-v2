...
<Check>
  Your Telegram integration is ready—users can now chat with your Botpress bot by messaging your Telegram bot. You can
  use the integration's [Cards](#cards) to manage the bot's typing indicators.
</Check>
