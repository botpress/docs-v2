...
import { Info, Note, Tip, Warning, Danger } from '@/components/callouts'
...
<Danger>
  Once you've successfully configured the Gmail integration, **the email address you provided will begin responding to
  all incoming emails as your bot**. Please be aware of this behaviour before configuring the integration.
</Danger>
