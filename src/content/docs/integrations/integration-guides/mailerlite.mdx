...
<Check>
  Your MailerLite integration is ready. You can use the integration's [Cards](#cards) to interact with your MailerLite
  subscribers.
</Check>
...
<IntegrationCards integration="mailerlite"/>

---

## Triggers

<IntegrationEvents integration="mailerlite"/>
...
<AccordionGroup>
  <Accordion title="An unexpected error occurred">
  ...
  <Accordion title="Invalid JSON">
    If you're passing data into the [Upsert Subscriber](#upsert-subscriber) Card's
    [`customFields`](#param-custom-fields) parameter, make sure it's a valid JSON string of key-value pairs..
  </Accordion>
</AccordionGroup>
