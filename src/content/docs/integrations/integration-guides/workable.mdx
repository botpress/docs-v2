...
<Check>
  Your integration is ready. You can use the integration's [Cards](#cards) and [Triggers](#triggers) to interact with
  your Workable candidates.
</Check>
...
<IntegrationCards integration="workable"/>

---

## Triggers

<IntegrationEvents integration="workable"/>
