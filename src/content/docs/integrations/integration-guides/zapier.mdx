...
{/* vale Botpress.workflows = NO */} 5. Now the rest of your trigger workflow can use the `{{ workflow.zapierData }}` variable to access the data you sent from Zapier.
{/* vale Botpress.workflows = YES */}
...
<IntegrationCards integration="zapier"/>

---

## Triggers

<IntegrationEvents integration="zapier"/>
