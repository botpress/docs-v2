...
import messengerReplyInDm1DarkImg from './assets/messenger-reply-in-dm-1-dark.png'
import messengerReplyInDm1Img from './assets/messenger-reply-in-dm-1.png'
import messengerReplyInDm2DarkImg from './assets/messenger-reply-in-dm-2-dark.png'
import messengerReplyInDm2Img from './assets/messenger-reply-in-dm-2.png'
import messengerReplyInDm3DarkImg from './assets/messenger-reply-in-dm-3-dark.png'
import messengerReplyInDm3Img from './assets/messenger-reply-in-dm-3.png'
import messengerReplyInDm4DarkImg from './assets/messenger-reply-in-dm-4-dark.png'
import messengerReplyInDm4Img from './assets/messenger-reply-in-dm-4.png'
...
import { Check, Info, Note } from '@/components/callouts'
...
<Note>This option is only available with [manual configuration](#manual-configuration).</Note>
...
<Steps>
  ...
  <Step>
    ...
    <Frame>
      <Picture alt="Reply to comments in DMs 1" class="block dark:hidden" src={messengerReplyInDm1Img}/>
      <Picture alt="Reply to comments in DMs 1" class="hidden dark:block" src={messengerReplyInDm1DarkImg}/>
    </Frame>
  ...
  <Step>
    ...
    <Frame>
      <Picture alt="Reply to comments in DMs 2" class="block dark:hidden" src={messengerReplyInDm2Img}/>
      <Picture alt="Reply to comments in DMs 2" class="hidden dark:block" src={messengerReplyInDm2DarkImg}/>
    </Frame>
...
<Steps>
  ...
  <Step>
    ...
    <Frame>
      <Picture alt="Reply to comments in DMs 3" class="block dark:hidden" src={messengerReplyInDm3Img}/>
      <Picture alt="Reply to comments in DMs 3" class="hidden dark:block" src={messengerReplyInDm3DarkImg}/>
    </Frame>
...
<Steps>
  ...
  <Step>
    ...
    <Frame>
      <Picture alt="Reply to comments in DMs 4" class="block dark:hidden" src={messengerReplyInDm4Img}/>
      <Picture alt="Reply to comments in DMs 4" class="hidden dark:block" src={messengerReplyInDm4DarkImg}/>
    </Frame>
