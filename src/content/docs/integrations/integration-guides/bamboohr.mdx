...
<Check>
  Your BambooHR integration is ready. You can use the integration's [Cards](#cards) and [Triggers](#triggers) to
  interact with your company's employees.
</Check>
...
<IntegrationCards integration="bamboohr"/>

## Triggers

<IntegrationEvents integration="bamboohr"/>
