...
import { Check, Info, Tip } from '@/components/callouts'
...
<Check>
  Your Apify integration is ready. You can use the integration's [Cards](#cards) and [Triggers](#triggers) to manage
  your Apify crawler runs.
</Check>

## Cards

Here’s a reference for all **[Cards](https://botpress.com/docs/studio/concepts/cards)** available with the integration:
<IntegrationCards/>

## Triggers

Here’s a reference for all **[Triggers](https://botpress.com/docs/studio/concepts/triggers)** available with the integration:
