...
<Check>
  Your Notion integration is ready to use. You can use the integration's [Cards](#cards) or [Triggers](#triggers) to
...
<IntegrationCards integration="notion"/>
...
<IntegrationEvents integration="notion"/>
