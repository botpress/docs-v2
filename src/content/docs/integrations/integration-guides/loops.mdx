...
<Steps>
  ...
  <Step>
    In the **Configuration** menu, you should see two fields: **API Key** and **Webhook Signing Secret**. Leave these
    blank for now—you'll come back to them after configuring the integration in Loops.
  </Step>
...
<Check>
  Your Loops integration is ready. You can use the integration's [Cards](#cards) and [Triggers](#triggers) to interact
  with your customer emails.
</Check>
...
<IntegrationCards integration="loops"/>

## Triggers

<IntegrationEvents integration="loops"/>
