...
import { Info, Note, Tip } from '@/components/callouts'
...
<Note>Webhooks don't return any data in the response body.</Note>

## Use webhook data in Studio

<Tip>
  You can [test the webhook in the Studio's emulator](/studio/concepts/triggers#test-a-trigger) to make sure you're
