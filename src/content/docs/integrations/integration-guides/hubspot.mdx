...
<Check>
  Your HubSpot integration is ready—you can use the integration's [Cards](/studio/concepts/cards/introduction) and
  [Triggers](/studio/concepts/triggers) to interact with your HubSpot account.
</Check>
...
<IntegrationCards integration="hubspot"/>

---

## Triggers

<IntegrationEvents integration="hubspot"/>
