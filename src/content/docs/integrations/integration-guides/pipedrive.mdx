...
import { Check, Info, Tip, Warning } from '@/components/callouts'
...
<Check>
  Your Pipedrive integration is ready. You can use the integration's [Cards](#cards) to interact with your Pipedrive
  contacts.
</Check>
