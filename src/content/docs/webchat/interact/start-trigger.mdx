...
import conversationStartedImg from './assets/conversation-started.png'
import welcomeMessageImg from './assets/welcome-message.png'
...
<Steps titleSize="h2">
    <Step title="Add the Conversation Started Trigger">
        ...
        <Frame>
        <Picture alt="Conversation Started Trigger" src={conversationStartedImg} />
        </Frame>
    ...
    <Step title="Setup your Trigger">
        ...
        <Frame>
        <Picture alt="Welcome message" src={welcomeMessageImg} />
        </Frame>
