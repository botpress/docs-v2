...
<Tip>
  You don't need to provide the entire `configuration` object every time—just the values that you want to update. Any
  fields you don't include will default to the most recent configuration.
</Tip>
