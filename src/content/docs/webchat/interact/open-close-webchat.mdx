...
import { Tip, Info } from '@/components/callouts'

You can manually open, close, or toggle the Webchat window using JavaScript methods.

<Tip>
  If you want to open/close your Webchat at a certain point in your Workflow, you can use the [built-in Webchat
  cards](/studio/concepts/cards/webchat).
</Tip>
