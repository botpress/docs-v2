...
import sendCustomEventImg from './assets/send-custom-event.png'
import sendCustomEventDarkImg from './assets/send-custom-event-dark.png'
...
<Steps titleSize="h3">
    <Step title="Add a Send Custom Event Card">
        ...
        <Frame>
          <Picture alt="Send Custom Event Card" class="block dark:hidden" src={sendCustomEventImg} />
          <Picture alt="Send Custom Event Card" class="hidden dark:block" src={sendCustomEventDarkImg} />
        </Frame>
        ...
        <Tip>
            You can also use [variables](/studio/concepts/variables/overview) to dynamically insert the contents of the **Event** field.
        </Tip>
