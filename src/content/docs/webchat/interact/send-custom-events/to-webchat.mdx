...
import { Info, Tip, Warning, Check } from '@/components/callouts'
...
import customTriggerImg from './assets/custom-trigger.png'
import customTriggerDarkImg from './assets/custom-trigger-dark.png'
import testTriggerImg from './assets/test-trigger.png'
import testTriggerDarkImg from './assets/test-trigger-dark.png'
...
<Tip>
  Visual learner? Check out our [YouTube guide](https://www.youtube.com/watch?v=dDGY_wHFt3s&pp=0gcJCY0JAYcqIYzv) on
...
<Steps>
    ...
    <Step title="Add a Custom Trigger">
      ...
      <Frame>
        <Picture alt="Custom Trigger" class="block dark:hidden" src={customTriggerImg} />
        <Picture alt="Custom Trigger" class="hidden dark:block" src={customTriggerDarkImg} />
      </Frame>
    ...
    <Step title="Test your trigger">
        ...
        <Frame>
          <Picture alt="Test Trigger" class="block dark:hidden" src={testTriggerImg} />
          <Picture alt="Test Trigger" class="hidden dark:block" src={testTriggerDarkImg} />
        </Frame>
...
<Check>Once you've re-published your bot, it'll respond to custom events.</Check>
...
<Steps>
  ...
  <Step title="Send an event to Webchat">
    ...
    ```jsx title="Send event button"
    <button onClick={() => client.sendEvent(customPayload)}>
      Send custom event
    </button>
    ```

    ```jsx title="Example in a full React app" expandable highlight={17-19, 23-25}
