...
import { Info, Note, Check, Tip } from '@/components/callouts'
...
<Note>
  This option isn't available if you're [embedding Webchat in a specific
  element](/webchat/get-started/embed-in-element).
</Note>
...
<Check>Done! This element will now toggle the Webchat window.</Check>
