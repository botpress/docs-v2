...
import { Info, Warning, Note } from '@/components/callouts'
...
<Warning>
  Styles from this section won't apply if you're using the [Webchat React library](/webchat/react-library/get-started).
  In this case, use the [configuration prop](/webchat/react-library/components/webchat#param-configuration) to configure
  Webchat.
</Warning>
...
#### Allowed origins {<Tooltip tip="This feature requires a Botpress Team plan or higher."><Badge variant="team">Team</Badge></Tooltip>}
