...
import { Info, Note, Check } from '@/components/callouts'
...
<Note>
  The Webchat React library requires React 18 or higher. Double-check your project's React version to ensure
  compatibility.
</Note>
...
<Check>You just built your first Webchat component!</Check>
