...
<ResponseField name="user" type="UserCredentials">
...
<ResponseField name="configuration" type="Configuration">
  Configuration for Webchat's appearance and style. This object's properties are similar to the Webchat configuration
  options available in the [Dashboard](/webchat/get-started/configure-your-webchat).
  <Expandable>
