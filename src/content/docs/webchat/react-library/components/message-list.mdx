...
<Warning>
  When using the `MessageList` component, you need to handle the creation of this array yourself. Copy the code example
  on this page for a working implementation.
</Warning>
