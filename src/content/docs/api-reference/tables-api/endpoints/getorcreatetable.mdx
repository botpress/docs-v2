        ...
        'application/json': {
          schema: {
            ...
            properties: {
              ...
              isComputeEnabled: { type: 'boolean', description: 'Indicates if the table is enabled for computation.' },
            },
            required: ['schema'],
          ...
          'application/json': {
            schema: {
              ...
              properties: {
                ...
                stale: { type: 'number', description: 'The number of stale rows that are waiting to be processed' },
                indexing: {
                  type: 'number',
