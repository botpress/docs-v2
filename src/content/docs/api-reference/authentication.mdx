...
<Tip>
  If you are looking to use the Webchat API or the Chat API to talk to your bot, please refer to the [Chat API
  documentation](/api-reference/chat-api/introduction) and [Webchat documentation](/webchat/get-started/introduction).
</Tip>
...
<Warning>
  Be careful, your PAT has the same access you have and can be used to access your data. Keep it safe and never share it
  with anyone.
</Warning>
...
<Note>
  If you are looking to self host your integration you can generate your own Integration Access Key instead of using
  your own PAT.
</Note>
