...
import knowledgeConsoleImg from '../assets/knowledge-console.png'
import knowledgeConsoleDarkImg from '../assets/knowledge-console-dark.png'
...
<Frame>
  <Picture alt="Knowledge page in dev console" class="block dark:hidden" src={knowledgeConsoleImg} />
  <Picture alt="Knowledge page in dev console" class="hidden dark:block" src={knowledgeConsoleDarkImg} />
</Frame>
