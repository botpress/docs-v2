...
<Frame>
  <Picture alt="Agent Steps panel in dev console" class="block dark:hidden" src={agentStepsImg} />
  <Picture alt="Agent Steps panel in dev console" class="hidden dark:block" src={agentStepsDarkImg} />
</Frame>
