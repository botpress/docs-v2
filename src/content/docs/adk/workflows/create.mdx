...
import workflowsConsoleImg from '../assets/workflows-console.png'
import workflowsConsoleDarkImg from '../assets/workflows-console-dark.png'
...
<Frame>
  <Picture alt="Workflows page in dev console" class="block dark:hidden" src={workflowsConsoleImg} />
  <Picture alt="Workflows page in dev console" class="hidden dark:block" src={workflowsConsoleDarkImg} />
</Frame>
