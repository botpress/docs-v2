...
<Note>
  Tags must be declared in `agent.config.ts` under `conversation.tags`. Check out our guide to [configuration your
  agent](/adk/setup/configuration#tags) for more information.
</Note>
