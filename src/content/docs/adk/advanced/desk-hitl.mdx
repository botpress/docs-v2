...
import deskUiImg from './assets/desk-ui.png'
import deskUiDarkImg from './assets/desk-ui-dark.png'
import deflectingImg from './assets/deflecting.png'
import deflectingDarkImg from './assets/deflecting-dark.png'
...
<Frame>
  <Picture alt="Botpress Desk main inbox view" class="block dark:hidden" src={deskUiImg} />
  <Picture alt="Botpress Desk main inbox view" class="hidden dark:block" src={deskUiDarkImg} />
</Frame>
...
<Steps>
  <Step>Run `adk deploy` to deploy your bot.</Step>
  <Step>Open [**Botpress Desk**](/desk/introduction).</Step>
  <Step>Go to **AI Agents → Deflecting Bots**.</Step>
  <Step>Add your bot.</Step>
</Steps>

<Frame>
  <Picture alt="Deflecting Bots page in Botpress Desk settings" class="block dark:hidden" src={deflectingImg} />
  <Picture alt="Deflecting Bots page in Botpress Desk settings" class="hidden dark:block" src={deflectingDarkImg} />
</Frame>

<Warning>
  If you skip this step, `startHitl` will fail with: _"This bot is not connected to Botpress Desk. Enable it on the
  Deflecting Bots page in Botpress Desk, then republish."_
</Warning>
