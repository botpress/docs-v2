...
import integrationsConsoleImg from '../assets/integrations-console.png'
import integrationsConsoleDarkImg from '../assets/integrations-console-dark.png'
import integrationConfigConsoleImg from '../assets/integration-config-console.png'
import integrationConfigConsoleDarkImg from '../assets/integration-config-console-dark.png'
...
<Frame>
  <Picture alt="Integrations page in dev console" class="block dark:hidden" src={integrationsConsoleImg} />
  <Picture alt="Integrations page in dev console" class="hidden dark:block" src={integrationsConsoleDarkImg} />
</Frame>
...
<Frame>
  <Picture alt="Integration configuration in dev console" class="block dark:hidden" src={integrationConfigConsoleImg} />
  <Picture
    alt="Integration configuration in dev console"
    class="hidden dark:block"
    src={integrationConfigConsoleDarkImg}
  />
</Frame>
...
<Note>
  For full documentation on managing integrations via the command line, check out the [CLI
  reference](/adk/cli-reference).
</Note>
