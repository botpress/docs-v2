...
import actionsConsoleImg from '../assets/actions-console.png'
import actionsConsoleDarkImg from '../assets/actions-console-dark.png'
...
<Frame>
  <Picture alt="Actions page in dev console" class="block dark:hidden" src={actionsConsoleImg} />
  <Picture alt="Actions page in dev console" class="hidden dark:block" src={actionsConsoleDarkImg} />
</Frame>
