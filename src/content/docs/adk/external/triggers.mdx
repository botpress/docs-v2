...
import triggersConsoleImg from '../assets/triggers-console.png'
import triggersConsoleDarkImg from '../assets/triggers-console-dark.png'
...
<Note>Trigger names must be at least 3 characters and contain only alphanumeric characters and underscores.</Note>
...
<Frame>
  <Picture alt="Triggers page in dev console" class="block dark:hidden" src={triggersConsoleImg} />
  <Picture alt="Triggers page in dev console" class="hidden dark:block" src={triggersConsoleDarkImg} />
</Frame>
