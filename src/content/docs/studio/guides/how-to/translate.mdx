...
<Frame>
  <img alt="Delivery status" class="block dark:hidden" src="./assets/delivery-status.png" />
  <img alt="Delivery status" class="hidden dark:block" src="./assets/delivery-status-dark.png" />
</Frame>
