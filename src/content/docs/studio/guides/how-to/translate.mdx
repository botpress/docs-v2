...
<Frame>![Translate name and description](/assets/studio/guides/how-to/assets/name-and-description.png)</Frame>

### Composer placeholder

To translate the placeholder text in the Composer, modify the **Composer placeholder** field:

<Frame>![Translate composer placeholder](/assets/studio/guides/how-to/assets/translate-composer.png)</Frame>
...
<Frame>![New conversation modal](/assets/studio/guides/how-to/assets/new-convo-modal.png)</Frame>
...
<Frame>![Today label](/assets/studio/guides/how-to/assets/today-label.png)</Frame>
...
<Frame>
  <img alt="Delivery status" class="block dark:hidden" src="/assets/studio/guides/how-to/assets/delivery-status.png" />
  <img
    alt="Delivery status"
    class="hidden dark:block"
    src="/assets/studio/guides/how-to/assets/delivery-status-dark.png"
  />
</Frame>
