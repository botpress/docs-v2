...
If your bot is having conversations in a language other than English, you can translate its [Webchat](/webchat/get-started/introduction) UI to match. This includes the bot's greeting, buttons, and any other text that appears in the Webchat window.
...
<Frame>![Translate name and description](./assets/name-and-description.png)</Frame>

### Composer placeholder

To translate the placeholder text in the Composer, modify the **Composer placeholder** field:

<Frame>![Translate composer placeholder](./assets/translate-composer.png)</Frame>
...
<Frame>![New conversation modal](./assets/new-convo-modal.png)</Frame>
...
<Frame>![Today label](./assets/today-label.png)</Frame>
...
<Check>Your bot's Webchat UI is now translated!</Check>
...
<Frame>
  <Picture alt="Delivery status" class="block dark:hidden" src={deliveryStatusImg} />
  <Picture alt="Delivery status" class="hidden dark:block" src={deliveryStatusDarkImg} />
</Frame>
