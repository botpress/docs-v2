...
<Frame>
  <Picture alt="Table" class="block dark:hidden" src={tableImg} />
  <Picture alt="Table" class="hidden dark:block" src={tableDarkImg} />
</Frame>
...
<Frame>
  <Picture alt="Table with AI spend" class="block dark:hidden" src={tableFullImg} />
  <Picture alt="Table with AI spend" class="hidden dark:block" src={tableFullDarkImg} />
</Frame>
