...
<Frame>
  <img alt="Table" class="block dark:hidden" src="./assets/table.png" />
  <img alt="Table" class="hidden dark:block" src="./assets/table-dark.png" />
</Frame>
...
<Frame>
  <img alt="Table with AI spend" class="block dark:hidden" src="./assets/table-full.png" />
  <img alt="Table with AI spend" class="hidden dark:block" src="./assets/table-full-dark.png" />
</Frame>
