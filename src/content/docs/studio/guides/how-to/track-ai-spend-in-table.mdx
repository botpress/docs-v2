...
<Frame>
  <img alt="Table" class="block dark:hidden" src="/assets/studio/guides/how-to/assets/table.png" />
  <img alt="Table" class="hidden dark:block" src="/assets/studio/guides/how-to/assets/table-dark.png" />
</Frame>
...
<Frame>
  <img alt="Table with AI spend" class="block dark:hidden" src="/assets/studio/guides/how-to/assets/table-full.png" />
  <img
    alt="Table with AI spend"
    class="hidden dark:block"
    src="/assets/studio/guides/how-to/assets/table-full-dark.png"
  />
</Frame>

<Check>Your table will now keep a record of your bot's AI spend for each turn.</Check>
