...
<Frame>
  <img alt="Fixed Schedule Trigger" class="block dark:hidden" src="./assets/fixed-schedule.png" />
  <img alt="Fixed Schedule Trigger" class="hidden dark:block" src="./assets/fixed-schedule-dark.png" />
</Frame>
...
<Frame>
  <img alt="Execute code" class="block dark:hidden" src="./assets/execute-code.png" />
  <img alt="Execute code" class="hidden dark:block" src="./assets/execute-code-dark.png" />
</Frame>
