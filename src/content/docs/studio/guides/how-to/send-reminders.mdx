...
<Frame>
  <Picture alt="Fixed Schedule Trigger" class="block dark:hidden" src={fixedScheduleImg} />
  <Picture alt="Fixed Schedule Trigger" class="hidden dark:block" src={fixedScheduleDarkImg} />
</Frame>
...
<Frame>
  <Picture alt="Execute code" class="block dark:hidden" src={executeCodeImg} />
  <Picture alt="Execute code" class="hidden dark:block" src={executeCodeDarkImg} />
</Frame>
