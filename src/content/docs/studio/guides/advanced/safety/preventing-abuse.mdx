...
### Rate Limits {<Tooltip tip="This feature requires a Botpress Team plan or higher."><span class="inline-flex items-center rounded-full border border-emerald-500/30 bg-emerald-50 px-2 py-0.5 text-xs font-medium text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-300">Team</span></Tooltip>}
...
### Allowed Origins {<Tooltip tip="This feature requires a Botpress Team plan or higher."><span class="inline-flex items-center rounded-full border border-emerald-500/30 bg-emerald-50 px-2 py-0.5 text-xs font-medium text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-300">Team</span></Tooltip>}
