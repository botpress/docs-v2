...
<CardGroup cols={3}>
  ...
  <Card title="Nodes" icon="SquareMousePointer" href="/studio/concepts/nodes/introduction">
    Steps in a Workflow
  </Card>
  <Card title="Cards" icon="Rows3" href="/studio/concepts/cards/introduction">
    Actions your bot can take within a Node
  </Card>
  <Card title="Knowledge Bases" icon="BookOpen" href="/studio/concepts/knowledge-base/introduction">
