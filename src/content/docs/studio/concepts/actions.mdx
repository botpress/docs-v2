...
<Tabs>
  <Tab title="Just write your prompt...">
    <Frame>
      <img alt="Action prompt" class="block dark:hidden" src="/assets/studio/concepts/assets/action-prompt.png" />
      <img alt="Action prompt" class="hidden dark:block" src="/assets/studio/concepts/assets/action-prompt-dark.png" />
    </Frame>
  </Tab>
  <Tab title="then use the generated Action.">
    <Frame>
      <img alt="Generated action" class="block dark:hidden" src="/assets/studio/concepts/assets/generated-action.png" />
      <img alt="Actions" class="hidden dark:block" src="/assets/studio/concepts/assets/generated-action-dark.png" />
    </Frame>
  </Tab>
</Tabs>
...
<Frame>
  <img
    ...
    src="/assets/studio/concepts/assets/action-prompt-example.png"
  />
  <img
    alt="Action prompt example"
    class="hidden dark:block"
    src="/assets/studio/concepts/assets/action-prompt-example-dark.png"
  />
</Frame>
...
<Frame>
  <img
    ...
    class="block dark:hidden"
    src="/assets/studio/concepts/assets/generated-action-code.png"
  />
  <img
    alt="Generated Action code"
    class="hidden dark:block"
    src="/assets/studio/concepts/assets/generated-action-code-dark.png"
  />
</Frame>
...
<Frame>
  <img alt="Manually provide inputs" class="block dark:hidden" src="/assets/studio/concepts/assets/manual-inputs.png" />
  <img
    alt="Manually provide inputs"
    class="hidden dark:block"
    src="/assets/studio/concepts/assets/manual-inputs-dark.png"
  />
</Frame>
