...
<Tabs>
  <Tab title="Just write your prompt...">
    <Frame>
      <img alt="Action prompt" class="block dark:hidden" src="./assets/action-prompt.png" />
      <img alt="Action prompt" class="hidden dark:block" src="./assets/action-prompt-dark.png" />
    </Frame>
  </Tab>
  <Tab title="then use the generated Action.">
    <Frame>
      <img alt="Generated action" class="block dark:hidden" src="./assets/generated-action.png" />
      <img alt="Actions" class="hidden dark:block" src="./assets/generated-action-dark.png" />
    </Frame>
  </Tab>
</Tabs>
...
<Frame>
  <img alt="Action prompt example" class="block dark:hidden" src="./assets/action-prompt-example.png" />
  <img alt="Action prompt example" class="hidden dark:block" src="./assets/action-prompt-example-dark.png" />
</Frame>

Your bot will generate code based on your prompt:

<Frame>
  <img alt="Generated Action code" class="block dark:hidden" src="./assets/generated-action-code.png" />
  <img alt="Generated Action code" class="hidden dark:block" src="./assets/generated-action-code-dark.png" />
</Frame>
...
<Frame>
  <img alt="Manually provide inputs" class="block dark:hidden" src="./assets/manual-inputs.png" />
  <img alt="Manually provide inputs" class="hidden dark:block" src="./assets/manual-inputs-dark.png" />
</Frame>
