...
<Note>Some Hook types take additional parameters—check out the Hook guides on this page for more information.</Note>
...
<IncomingEvent />
<Field name="outgoingEvent" type="IO.OutgoingEvent">
...
<IncomingEvent />
<Field name="execution" type="LLMZ.ExecutionResult">
...
<IncomingEvent />
<Field name="iteration" type="LLMZ.IterationResult">
