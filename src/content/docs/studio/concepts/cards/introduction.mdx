...
<Frame>
  <img alt="Cards" class="block dark:hidden" src="/assets/studio/concepts/cards/assets/cards.png" />
  <img alt="Cards" class="hidden dark:block" src="/assets/studio/concepts/cards/assets/cards-dark.png" />
</Frame>
...
<Frame>
  <img alt="Card inspector" class="block dark:hidden" src="/assets/studio/concepts/cards/assets/card-inspector.png" />
  <img
    alt="Card inspector"
    class="hidden dark:block"
    src="/assets/studio/concepts/cards/assets/card-inspector-dark.png"
  />
</Frame>
