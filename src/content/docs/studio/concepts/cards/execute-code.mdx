...
<Frame>
  <img alt="Generate code using AI" class="block dark:hidden" src="./assets/execute-code.png" />
  <img alt="Generate code using AI" class="hidden dark:block" src="./assets/execute-code-dark.png" />
</Frame>
