...
<Frame>
  <Picture alt="Knowledge Base" class="block dark:hidden" src={knowledgeBaseImg} />
  <Picture alt="Knowledge Base" class="hidden dark:block" src={knowledgeBaseDarkImg} />
</Frame>
...
<Frame>
  <Picture
    ...
    src={exampleInstructionsPolicyImg}
  />
  <Picture
    alt="Example instructions for company policy search"
    class="hidden dark:block"
    src={exampleInstructionsPolicyDarkImg}
  />
</Frame>
...
<Frame>
  <Picture
    ...
    class="block dark:hidden"
    src={exampleInstructionsPricingImg}
  />
  <Picture
    alt="Example instructions for pricing search"
    class="hidden dark:block"
    src={exampleInstructionsPricingDarkImg}
  />
</Frame>
