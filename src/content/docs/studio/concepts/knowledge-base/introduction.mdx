...
<Icon icon="BookOpen" /> Knowledge Bases are **sources of information you provide to your bot**.

<Frame>
  <img
    alt="Knowledge Base"
    class="block dark:hidden"
    src="/assets/studio/concepts/knowledge-base/assets/knowledge-base.png"
  />
  <img
    alt="Knowledge Base"
    class="hidden dark:block"
    src="/assets/studio/concepts/knowledge-base/assets/knowledge-base-dark.png"
  />
</Frame>
...
1. Navigate to the <Icon icon="BookOpen"/> **Knowledge Base** menu in the studio.
...
<CardGroup cols={3}>
  <Card title="Websites" icon="AppWindow" href="/studio/concepts/knowledge-base/add-sources#websites" horizontal />
  <Card title="Documents" icon="FileText" href="/studio/concepts/knowledge-base/add-sources#documents" horizontal />
  <Card title="Tables" icon="Table" href="/studio/concepts/knowledge-base/add-sources#tables" horizontal />
  <Card
    ...
    horizontal
  />
  <Card title="Rich text" icon="Type" href="/studio/concepts/knowledge-base/add-sources#rich-text" horizontal />
  <Card
    title="Integrations"
    icon="Boxes"
...
<Frame>
  <img
    ...
    class="block dark:hidden"
    src="/assets/studio/concepts/knowledge-base/assets/example-instructions-policy.png"
  />
  <img
    alt="Example instructions for company policy search"
    class="hidden dark:block"
    src="/assets/studio/concepts/knowledge-base/assets/example-instructions-policy-dark.png"
  />
</Frame>
...
<Frame>
  <img
    ...
    class="block dark:hidden"
    src="/assets/studio/concepts/knowledge-base/assets/example-instructions-pricing.png"
  />
  <img
    alt="Example instructions for pricing search"
    class="hidden dark:block"
    src="/assets/studio/concepts/knowledge-base/assets/example-instructions-pricing-dark.png"
  />
</Frame>
