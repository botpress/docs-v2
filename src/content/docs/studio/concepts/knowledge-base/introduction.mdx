...
<Frame>
  <img alt="Knowledge Base" class="block dark:hidden" src="./assets/knowledge-base.png" />
  <img alt="Knowledge Base" class="hidden dark:block" src="./assets/knowledge-base-dark.png" />
</Frame>
