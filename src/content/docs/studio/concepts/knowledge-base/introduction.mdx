...
<CardGroup cols={3}>
  <Card title="Websites" icon="app-window" href="/studio/concepts/knowledge-base/add-sources#websites" horizontal />
  <Card title="Documents" icon="file-text" href="/studio/concepts/knowledge-base/add-sources#documents" horizontal />
