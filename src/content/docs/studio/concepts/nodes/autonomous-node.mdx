...
<Frame>
  <img alt="alt" class="block dark:hidden" src="/assets/studio/concepts/nodes/assets/an.png" />
  <img alt="alt" class="hidden dark:block" src="/assets/studio/concepts/nodes/assets/an-dark.png" />
</Frame>
...
1. Select the Autonomous Node to open its configuration menu.
2. Open **<Icon icon="ChevronRight"/>Advanced settings**.
3. Enable either:
