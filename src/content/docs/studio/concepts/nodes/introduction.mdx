...
<Frame>
  <img alt="Nodes" class="block dark:hidden" src="/assets/studio/concepts/nodes/assets/node.png" />
  <img alt="Nodes" class="hidden dark:block" src="/assets/studio/concepts/nodes/assets/node-dark.png" />
</Frame>
...
<Frame>
  <img alt="Transition" class="block dark:hidden" src="/assets/studio/concepts/nodes/assets/transition.png" />
  <img alt="Transition" class="hidden dark:block" src="/assets/studio/concepts/nodes/assets/transition-dark.png" />
</Frame>
