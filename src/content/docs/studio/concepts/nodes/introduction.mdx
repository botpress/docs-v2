...
<Frame>
  <img alt="Nodes" class="block dark:hidden" src="./assets/node.png" />
  <img alt="Nodes" class="hidden dark:block" src="./assets/node-dark.png" />
</Frame>
...
<Frame>
  <img alt="Transition" class="block dark:hidden" src="./assets/transition.png" />
  <img alt="Transition" class="hidden dark:block" src="./assets/transition-dark.png" />
</Frame>
