...
<Frame>
  <img alt="Workflow" class="block dark:hidden" src="/assets/studio/concepts/assets/workflow.png" />
  <img alt="Workflow" class="hidden dark:block" src="/assets/studio/concepts/assets/workflow-dark.png" />
</Frame>
...
<Frame>
  <img alt="Default Workflows" class="block dark:hidden" src="/assets/studio/concepts/assets/default-workflows.png" />
  <img
    alt="Default Workflows"
    class="hidden dark:block"
    src="/assets/studio/concepts/assets/default-workflows-dark.png"
  />
</Frame>
...
<Frame>
  <img alt="Main Workflow" class="block dark:hidden" src="/assets/studio/concepts/assets/main-workflow.png" />
  <img alt="Main Workflow" class="hidden dark:block" src="/assets/studio/concepts/assets/main-workflow-dark.png" />
</Frame>
...
<Frame>
  <img alt="Error Workflow" class="block dark:hidden" src="/assets/studio/concepts/assets/error-workflow.png" />
  <img alt="Error Workflow" class="hidden dark:block" src="/assets/studio/concepts/assets/error-workflow-dark.png" />
</Frame>
...
<Frame>
  <img alt="Timeout Workflow" class="block dark:hidden" src="/assets/studio/concepts/assets/timeout-workflow.png" />
  <img
    alt="Timeout Workflow"
    class="hidden dark:block"
    src="/assets/studio/concepts/assets/timeout-workflow-dark.png"
  />
</Frame>
...
<Frame>
  <img alt="Conversation End" class="block dark:hidden" src="/assets/studio/concepts/assets/end-workflow.png" />
  <img alt="Conversation End" class="hidden dark:block" src="/assets/studio/concepts/assets/end-workflow-dark.png" />
</Frame>
...
<Frame>
  <img alt="Workflows section" class="block dark:hidden" src="/assets/studio/concepts/assets/workflows-menu.png" />
  <img alt="Workflows section" class="hidden dark:block" src="/assets/studio/concepts/assets/workflows-menu-dark.png" />
</Frame>

Then, select **Create Workflow** and enter a name for the new Workflow:

<Frame>
  <img alt="New Workflow" class="block dark:hidden" src="/assets/studio/concepts/assets/new-workflow.png" />
  <img alt="New Workflow" class="hidden dark:block" src="/assets/studio/concepts/assets/new-workflow-dark.png" />
</Frame>
...
<Frame>
  <img alt="Workflows on Hub" class="block dark:hidden" src="/assets/studio/concepts/assets/workflows-hub.png" />
  <img alt="Workflows on Hub" class="hidden dark:block" src="/assets/studio/concepts/assets/workflows-hub-dark.png" />
</Frame>
...
<Frame>
  <img alt="Flow Logic" class="block dark:hidden" src="/assets/studio/concepts/assets/flow-logic.png" />
  <img alt="Flow Logic" class="hidden dark:block" src="/assets/studio/concepts/assets/flow-logic-dark.png" />
</Frame>

To transition to a new Workflow, just add it to the Node you want to transition from:

<Frame>
  <img alt="Transition Card" class="block dark:hidden" src="/assets/studio/concepts/assets/transition-card.png" />
  <img alt="Transition Card" class="hidden dark:block" src="/assets/studio/concepts/assets/transition-card-dark.png" />
</Frame>
...
<Frame>
  <img alt="Workflow folders" class="block dark:hidden" src="/assets/studio/concepts/assets/workflow-folders.png" />
  <img
    alt="Workflow folders"
    class="hidden dark:block"
    src="/assets/studio/concepts/assets/workflow-folders-dark.png"
  />
</Frame>
...
You can share any Workflow you create on [Botpress Hub](/integrations/get-started/botpress-hub) to make it available to other users. Just select **Share Workflow** <Icon icon="ExternalLink"/> in the upper-right corner of the Workflow and fill out the required fields.
