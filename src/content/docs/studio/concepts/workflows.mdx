...
<Frame>
  <Picture alt="Workflow" class="block dark:hidden" src={workflowImg} />
  <Picture alt="Workflow" class="hidden dark:block" src={workflowDarkImg} />
</Frame>
...
<Frame>
  <Picture alt="Default Workflows" class="block dark:hidden" src={defaultWorkflowsImg} />
  <Picture alt="Default Workflows" class="hidden dark:block" src={defaultWorkflowsDarkImg} />
</Frame>
...
<Frame>
  <Picture alt="Error Workflow" class="block dark:hidden" src={errorWorkflowImg} />
  <Picture alt="Error Workflow" class="hidden dark:block" src={errorWorkflowDarkImg} />
</Frame>
...
<Frame>
  <Picture alt="Timeout Workflow" class="block dark:hidden" src={timeoutWorkflowImg} />
  <Picture alt="Timeout Workflow" class="hidden dark:block" src={timeoutWorkflowDarkImg} />
</Frame>
...
<Frame>
  <Picture alt="Conversation End" class="block dark:hidden" src={endWorkflowImg} />
  <Picture alt="Conversation End" class="hidden dark:block" src={endWorkflowDarkImg} />
</Frame>
...
<Frame>
  <Picture alt="Workflows section" class="block dark:hidden" src={workflowsMenuImg} />
  <Picture alt="Workflows section" class="hidden dark:block" src={workflowsMenuDarkImg} />
</Frame>

Then, select **Create Workflow** and enter a name for the new Workflow:

<Frame>
  <Picture alt="New Workflow" class="block dark:hidden" src={newWorkflowImg} />
  <Picture alt="New Workflow" class="hidden dark:block" src={newWorkflowDarkImg} />
</Frame>
...
<Frame>
  <Picture alt="Workflows on Hub" class="block dark:hidden" src={workflowsHubImg} />
  <Picture alt="Workflows on Hub" class="hidden dark:block" src={workflowsHubDarkImg} />
</Frame>
...
<Frame>
  <Picture alt="Flow Logic" class="block dark:hidden" src={flowLogicImg} />
  <Picture alt="Flow Logic" class="hidden dark:block" src={flowLogicDarkImg} />
</Frame>

To transition to a new Workflow, just add it to the Node you want to transition from:

<Frame>
  <Picture alt="Transition Card" class="block dark:hidden" src={transitionCardImg} />
  <Picture alt="Transition Card" class="hidden dark:block" src={transitionCardDarkImg} />
</Frame>
...
<Frame>
  <Picture alt="Workflow folders" class="block dark:hidden" src={workflowFoldersImg} />
  <Picture alt="Workflow folders" class="hidden dark:block" src={workflowFoldersDarkImg} />
</Frame>
