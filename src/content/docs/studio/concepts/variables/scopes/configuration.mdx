...
<Frame>![Configuration variables](/assets/studio/concepts/variables/scopes/assets/configuration-variables.png)</Frame>

3. Select **+**, then enter a **Name** and **Value** for your variable:

<Frame>
  ![Configuration variable fields](/assets/studio/concepts/variables/scopes/assets/configuration-fields.png)
</Frame>
...
<Frame>
  ![Access configuration variable in an Execute Code
  Card](/assets/studio/concepts/variables/scopes/assets/access-config-var.png)
</Frame>
