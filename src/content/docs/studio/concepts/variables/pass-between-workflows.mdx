  ...
  <Step title="Setup your input variable">
    ...
    <Frame>
      <img
        ...
        src="/assets/studio/concepts/variables/assets/toggle-input-variable.png"
      />
      <img
        alt="Toggle input variable"
        class="hidden dark:block"
        src="/assets/studio/concepts/variables/assets/toggle-input-variable-dark.png"
      />
    </Frame>
  ...
  <Step title="Pass the variable to the sub-Workflow">
    ...
    <Frame>
      <img
        ...
        class="block dark:hidden"
        src="/assets/studio/concepts/variables/assets/input-var-field.png"
      />
      <img
        alt="Input variable field"
        class="hidden dark:block"
        src="/assets/studio/concepts/variables/assets/input-var-field-dark.png"
      />
    </Frame>
  ...
  <Step title="Pass your output variable">
    ...
    <Frame>
      <img
        ...
        class="block dark:hidden"
        src="/assets/studio/concepts/variables/assets/toggle-output-variable.png"
      />
      <img
        alt="Toggle output variable"
        class="hidden dark:block"
        src="/assets/studio/concepts/variables/assets/toggle-output-variable-dark.png"
      />
    </Frame>
  ...
  <Step title="Configure the sub-Workflow Card">
    ...
    <Frame>
      <img
        alt="Workflow Card"
        class="block dark:hidden"
        src="/assets/studio/concepts/variables/assets/workflow-card.png"
      />
      <img
        alt="Workflow Card"
        class="hidden dark:block"
        src="/assets/studio/concepts/variables/assets/workflow-card-dark.png"
      />
    </Frame>
  ...
  <Step title="Read the output variable in the parent Workflow">
    ...
    <Frame>
      <img
        ...
        class="block dark:hidden"
        src="/assets/studio/concepts/variables/assets/read-variable.png"
      />
      <img
        alt="Read output variable"
        class="hidden dark:block"
        src="/assets/studio/concepts/variables/assets/read-variable-dark.png"
      />
    </Frame>
