...
<Frame>![Trigger](./assets/trigger.png)</Frame>
...
<Frame>![Add a Trigger](./assets/add-trigger.png)</Frame>
...
<Frame>![Welcome message](./assets/welcome-message.png)</Frame>
...
<Frame>![Custom Trigger reacting to buttons](./assets/custom-trigger-buttons.png)</Frame>
