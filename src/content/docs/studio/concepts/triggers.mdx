...
<Frame>![Trigger](/assets/studio/concepts/assets/trigger.png)</Frame>
...
<Frame>![Add a Trigger](/assets/studio/concepts/assets/add-trigger.png)</Frame>
...
<Steps>
    <Step title="Add the Trigger to your Workflow">
        Right-click anywhere in your Workflow. Select **Trigger**, then **Conversation Started**:
            ...
            <Frame>
                ![Conversation Started](/assets/studio/concepts/assets/conversation-started.png)
            </Frame>
    </Step>
    <Step title="Configure a test">
        Select **Test** in the bottom-left corner of the Trigger:
            ...
            <Frame>
                ![Test Trigger](/assets/studio/concepts/assets/test-trigger.png)
            </Frame>

            Then, select **Show last received events**. This will display a list of past events that would set off your Trigger:

            <Frame>
                ![Test events](/assets/studio/concepts/assets/test-events.png)
            </Frame>
    ...
    <Step title="Test the Trigger">
        Now, you should see the name of the event in the Trigger:
            ...
            <Frame>
                ![Fire Trigger](/assets/studio/concepts/assets/fire-trigger.png)
            </Frame>

        Just press the play icon to fire the Trigger. Any logic you have connected to the Trigger will execute in the emulator:

            <Frame>
                ![Trigger fires in emulator](/assets/studio/concepts/assets/trigger-emulator.png)
            </Frame>
    </Step>
...
<Frame>![Welcome message](/assets/studio/concepts/assets/welcome-message.png)</Frame>
...
<Frame>![Custom Trigger reacting to buttons](/assets/studio/concepts/assets/custom-trigger-buttons.png)</Frame>
...
<Tip>Check out the [integrations section](/integrations/) for information about integration-specific Triggers.</Tip>
...
![Zendesk Triggers](/assets/studio/concepts/assets/zendesk-triggers.png)
