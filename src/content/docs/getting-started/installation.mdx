...
import { Tip, Warning } from '../../../components/Callout.tsx'
...
<Tip>
  If you encounter permission errors on macOS or Linux, try prefixing the command with `sudo` or configure npm to use a
  different directory for global packages.
</Tip>
