...
<Frame>
  <img alt="Home" className="block dark:hidden" src="/assets/get-started/home.png" />
  <img alt="Home" className="hidden dark:block" src="/assets/get-started/home-dark.png" />
</Frame>
...
<Frame>
  <img alt="Usage" className="block dark:hidden" src="/assets/get-started/usage.png" />
  <img alt="Usage" className="hidden dark:block" src="/assets/get-started/usage-dark.png" />
</Frame>
...
<AccordionGroup>
  ...
  <Accordion title="Where can I find Botpress invoices?">
    ...
    <Icon icon="credit-card" /> Billing** menu.
  </Accordion>
