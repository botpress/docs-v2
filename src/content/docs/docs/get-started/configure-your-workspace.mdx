...
<Callout variant="note">There is no limit to the number of workspaces you can create on one account.</Callout>
...
<Callout variant="note">You can always increase any limits in the [Billing menu](#billing).</Callout>
