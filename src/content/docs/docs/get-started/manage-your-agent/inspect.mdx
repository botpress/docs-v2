...
<Frame>
  <img alt="Logs" className="block dark:hidden" src="/assets/manage-your-agent/logs.png" />
  <img alt="Logs" className="hidden dark:block" src="/assets/manage-your-agent/logs-dark.png" />
</Frame>
...
<Frame>
  <img alt="Events" className="block dark:hidden" src="/assets/manage-your-agent/events.png" />
  <img alt="Events" className="hidden dark:block" src="/assets/manage-your-agent/events-dark.png" />
</Frame>
...
<Frame>
  <img alt="Event JSON data" className="block dark:hidden" src="/assets/manage-your-agent/event-json-data.png" />
  <img alt="Event JSON data" className="hidden dark:block" src="/assets/manage-your-agent/event-json-data-dark.png" />
</Frame>
...
<Frame>
  <img alt="File JSON data" className="block dark:hidden" src="/assets/manage-your-agent/file-json-data.png" />
  <img alt="File JSON data" className="hidden dark:block" src="/assets/manage-your-agent/file-json-data-dark.png" />
</Frame>
...
<Frame>
  <img alt="Issues" className="block dark:hidden" src="/assets/manage-your-agent/issues.png" />
  <img alt="Issues" className="hidden dark:block" src="/assets/manage-your-agent/issues-dark.png" />
</Frame>
...
<Frame>
  <img alt="Issue events" className="block dark:hidden" src="/assets/manage-your-agent/issue-events.png" />
  <img alt="Issue events" className="hidden dark:block" src="/assets/manage-your-agent/issue-events-dark.png" />
</Frame>
