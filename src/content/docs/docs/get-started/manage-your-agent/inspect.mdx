...
<Frame>
  <img alt="Logs" class="block dark:hidden" src="/assets/manage-your-agent/logs.png" />
  <img alt="Logs" class="hidden dark:block" src="/assets/manage-your-agent/logs-dark.png" />
</Frame>
...
<Frame>
  <img alt="Events" class="block dark:hidden" src="/assets/manage-your-agent/events.png" />
  <img alt="Events" class="hidden dark:block" src="/assets/manage-your-agent/events-dark.png" />
</Frame>
...
<Frame>
  <img alt="Event JSON data" class="block dark:hidden" src="/assets/manage-your-agent/event-json-data.png" />
  <img alt="Event JSON data" class="hidden dark:block" src="/assets/manage-your-agent/event-json-data-dark.png" />
</Frame>
...
<Frame>
  <img alt="File JSON data" class="block dark:hidden" src="/assets/manage-your-agent/file-json-data.png" />
  <img alt="File JSON data" class="hidden dark:block" src="/assets/manage-your-agent/file-json-data-dark.png" />
</Frame>
...
To download a file, select <Icon icon="EllipsisVertical"/> to open additional options, then <Icon icon="Download"/> **Download**.

### Delete a file

To delete a file, select <Icon icon="EllipsisVertical"/> to open additional options, then <Icon icon="Trash2"/> **Delete**.
...
<Frame>
  <img alt="Issues" class="block dark:hidden" src="/assets/manage-your-agent/issues.png" />
  <img alt="Issues" class="hidden dark:block" src="/assets/manage-your-agent/issues-dark.png" />
</Frame>
...
<Frame>
  <img alt="Issue events" class="block dark:hidden" src="/assets/manage-your-agent/issue-events.png" />
  <img alt="Issue events" class="hidden dark:block" src="/assets/manage-your-agent/issue-events-dark.png" />
</Frame>
