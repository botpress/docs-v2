...
<Steps>
  <Step>
    Go to the **
    <Icon icon="layout-panel-left" /> Overview** section in your agent's menu.
  </Step>
  <Step>
    Select **
    <Icon icon="external-link" /> Preview** to open the preview.
  </Step>
</Steps>
...
<Frame>
  <img alt="Preview" className="block dark:hidden" src="/assets/manage-your-agent/preview.png" />
  <img alt="Preview" className="hidden dark:block" src="/assets/manage-your-agent/preview-dark.png" />
</Frame>
