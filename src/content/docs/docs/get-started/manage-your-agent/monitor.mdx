...
<Frame>
  <img alt="Conversation" className="block dark:hidden" src="/assets/manage-your-agent/conversation.png" />
  <img alt="Conversation" className="hidden dark:block" src="/assets/manage-your-agent/conversation-dark.png" />
</Frame>
...
<Frame>
  <img alt="Message JSON data" className="block dark:hidden" src="/assets/manage-your-agent/message-json-data.png" />
  <img
    alt="Message JSON data"
    className="hidden dark:block"
    src="/assets/manage-your-agent/message-json-data-dark.png"
  />
</Frame>
...
<Frame>
  <img alt="AI insights" className="block dark:hidden" src="/assets/manage-your-agent/ai-insights.png" />
  <img alt="AI insights" className="hidden dark:block" src="/assets/manage-your-agent/ai-insights-dark.png" />
</Frame>
...
<Frame>
  <img alt="Analytics" className="block dark:hidden" src="/assets/manage-your-agent/analytics.png" />
  <img alt="Analytics" className="hidden dark:block" src="/assets/manage-your-agent/analytics-dark.png" />
</Frame>
