...
<Frame>
  <img alt="Conversation" class="block dark:hidden" src="/assets/manage-your-agent/conversation.png" />
  <img alt="Conversation" class="hidden dark:block" src="/assets/manage-your-agent/conversation-dark.png" />
</Frame>
...
<Frame>
  <img alt="Message JSON data" class="block dark:hidden" src="/assets/manage-your-agent/message-json-data.png" />
  <img alt="Message JSON data" class="hidden dark:block" src="/assets/manage-your-agent/message-json-data-dark.png" />
</Frame>
...
<Frame>
  <img alt="AI insights" class="block dark:hidden" src="/assets/manage-your-agent/ai-insights.png" />
  <img alt="AI insights" class="hidden dark:block" src="/assets/manage-your-agent/ai-insights-dark.png" />
</Frame>
...
<Frame>
  <img alt="Analytics" class="block dark:hidden" src="/assets/manage-your-agent/analytics.png" />
  <img alt="Analytics" class="hidden dark:block" src="/assets/manage-your-agent/analytics-dark.png" />
</Frame>
