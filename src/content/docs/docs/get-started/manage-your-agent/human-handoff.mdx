...
import { Tip } from '@/components/callout'
...
<Frame>
  <img
    ...
    src="/assets/manage-your-agent/pending-conversation.png"
  />
  <img
    alt="Pending conversation"
...
<Frame>
  <img
    ...
    className="block dark:hidden"
    src="/assets/manage-your-agent/assign-conversation.png"
  />
  <img
    alt="Assign conversation"
    className="hidden dark:block"
...
<Frame>
  <img alt="Respond to user" className="block dark:hidden" src="/assets/manage-your-agent/respond-to-user.png" />
  <img alt="Respond to user" className="hidden dark:block" src="/assets/manage-your-agent/respond-to-user-dark.png" />
</Frame>
