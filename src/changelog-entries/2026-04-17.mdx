...
import imgStudioConceptsNodesAn from '../content/docs/studio/concepts/nodes/assets/an.png'
import imgStudioConceptsNodesAnDark from '../content/docs/studio/concepts/nodes/assets/an-dark.png'
