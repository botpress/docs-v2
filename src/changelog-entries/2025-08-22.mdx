...
import imgStudioConceptsCardsCardInspector from '../content/docs/studio/concepts/cards/assets/card-inspector.png'
import imgStudioConceptsCardsCardInspectorDark from '../content/docs/studio/concepts/cards/assets/card-inspector-dark.png'
